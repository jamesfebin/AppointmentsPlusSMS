...
class Appointments {
	...
	var $MYCOMPANYNAME = "INSERT YOUR COMPANY NAME HERE";
	var $SENDER_ID = "INSERT YOUR SEND_ID HERE (Letters or numbers) without spaces upto 11 charecters";
	var $SMSAPIUSERNAME = "INSERT YOUR USERNAME HERE";
	var $SMSAPIPASSWORD = "INSERT YOUR PASSWORD HERE";
...
*/
	...
	function sendSMS( $phone,$start ) {
		...
		$SMSMessage = "You has an appointment with " + $MYCOMPANYNAME + " on " + date('Y-m-d H:i',$start);
